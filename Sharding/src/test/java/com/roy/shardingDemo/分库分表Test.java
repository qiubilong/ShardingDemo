...
//    @Transactional
    ...
    public void queryCourse() {
        ...
        //wrapper.eq("cid",1106253188056481793L);
        //wrapper.in("cid",1106253188056481793L,1106255490347696130L,222L);
        //带上排序条件不影响分片逻辑
    ...
    public void queryCourseComplexSimple(){
        QueryWrapper<Course> wrapper = new QueryWrapper<Course>();
//        wrapper.orderByDesc("user_id");
        wrapper.in("cid",1106253188056481793L,851198095139012609L);
//        wrapper.between("cid",799020475735871489L,799020475802980353L);
